...
launcher = 'none'
load_from = '/root/autodl-tmp/robust-waste-detection-main-improve/weights/final_sota/best_swa_0.545.pth'
log_level = 'INFO'
...
model = dict(
    ...
    test_cfg=dict(max_per_img=300, rcnn=dict(score_thr=0.008)),
    train_cfg=dict(
        assigner=dict(
            match_costs=[
...
test_evaluator = dict(
    ...
    metric='bbox',
    outfile_prefix=
    '/root/autodl-tmp/robust-waste-detection-main-improve/data/pseudo_labels/raw_s0008',
    type='CocoMetric')
test_pipeline = [
    dict(backend_args=None, type='LoadImageFromFile'),
    dict(keep_ratio=True, scale=(
