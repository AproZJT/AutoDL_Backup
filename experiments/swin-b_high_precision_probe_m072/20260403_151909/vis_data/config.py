...
optim_wrapper = dict(
    ...
    optimizer=dict(lr=1e-06, type='AdamW', weight_decay=0.0001),
    paramwise_cfg=dict(
        custom_keys=dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        datasets=[
            dict(
                ...
                pipeline=[
                    ...
                    dict(
                        ...
                        type='RandomChoice'),
                    dict(flag_value=False, type='SetPseudoFlag'),
                    dict(
                        meta_keys=(
                            'img_id',
                            'img_path',
            ...
            dict(
                ann_file=
                './data/pseudo_labels/zerowaste-s_ensemble_consensus_pseudo_annotations_offset.json',
                backend_args=None,
                ...
                pipeline=[
                    ...
                    dict(
                        ...
                        type='RandomChoice'),
                    dict(flag_value=True, type='SetPseudoFlag'),
                    dict(
                        meta_keys=(
                            'img_id',
                            'img_path',
...
work_dir = 'experiments/swin-b_high_precision_probe_m072'
