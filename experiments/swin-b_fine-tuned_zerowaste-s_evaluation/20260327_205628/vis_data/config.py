...
launcher = 'none'
load_from = 'external_modules/mmdetection/experiments/swin-b_zerowaste_semi-supervised/best_coco_bbox_mAP_epoch_12.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ann_file='./data/zerowaste-s/labels.json',
    backend_args=None,
    classwise=True,
    format_only=False,
    metric='bbox',
