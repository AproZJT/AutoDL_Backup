...
train_dataloader = dict(
    ...
    dataset=dict(
        datasets=[
            dict(
                ann_file='zerowaste-f/train/labels.json',
                backend_args=None,
                ...
                type='CocoDataset'),
            dict(
                ann_file='zerowaste-f/teacher_pseudo_labels_high_prec.json',
                backend_args=None,
                data_prefix=dict(img='zerowaste-f/train/data/'),
                data_root='./data/',
                filter_cfg=dict(filter_empty_gt=False, min_size=0),
...
val_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='zerowaste-f/val/labels.json',
        backend_args=None,
        data_prefix=dict(img='zerowaste-f/val/data/'),
        data_root='./data/',
        metainfo=dict(
            classes=(
                'rigid_plastic',
    ...
    sampler=dict(shuffle=False, type='DefaultSampler'))
val_evaluator = dict(
    ann_file='./data/zerowaste-f/val/labels.json',
    backend_args=None,
    classwise=True,
    format_only=False,
    metric='bbox',
...
work_dir = './work_dirs/phase2_swinT_student'
